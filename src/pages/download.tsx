  ...
  return (
    <header className={clsx('hero hero--primary', styles.heroBanner)}>
      <div className="container">
        ...
        <p style={{fontWeight: 'bold', color: 'red', padding: '8px', background: 'white', borderRadius: '15px'}}>The latest versions 5.13.1 and higher are not available from this downloads page</p>
        <a
            className="button dlbutton button--secondary button--lg"
            href="https://cdn.modrinth.com/data/17DyGUnO/versions/bGc2nQqF/notquests-5.13.0.jar">
            ⏬ 5.13.0 <span style={{fontWeight: '400'}}>for Minecraft 1.19.3 ⭐</span>
        </a>

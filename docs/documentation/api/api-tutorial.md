...
This example targets **NotQuests 7.0.0-beta.3**, **Minecraft 26.2**, **Java 25**, and Paper. The objective and variable themselves use the portable API and can also live in a shared module for NeoForge.
